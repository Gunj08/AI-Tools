    ...
    <div className="max-w-md mx-auto px-4 pt-10 pb-20">
      ...
      <div className="glass rounded-3xl p-8 border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h2 className="font-display font-black text-2xl text-white">Sign Up</h2>
          <p className="text-slate-400 text-xs mt-1">Create an account to bookmark tools, write reviews, and more</p>
        </div>
